// Инструкция 4: AppManager становится синглтоном — один браузер на все тесты.
// Аналог ThreadLocal<AppManager> + GetInstance() из C#.
package test4
...
// GetInstance — возвращает единственный экземпляр AppManager
...
// Stop — деструктор AppManager, вызывается один раз в конце всех тестов
